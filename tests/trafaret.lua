...
describe("trafaret: enum", function()
    local alt = T.Enum { "x", "y" }
    test("valid", function()
        local res, val, _ = T.validate(alt, "x")
        assert(res)
        assert.is.same(val, "x")
    ...
    test("invalid", function()
        local res, val, _ = T.validate(alt, "z")
        assert(not res)
        assert.is.same(val, nil)
    end)
end)

describe("trafaret: any", function()
    local any = T.Any {}
    test("str", function()
        local res, val, _ = T.validate(any, "x")
        assert(res)
        assert.is.same(val, "x")
    end)
    test("dict", function()
        local res, val, _ = T.validate(any, {})
        assert(res)
        assert.is.same(val, {})
    end)
end)
